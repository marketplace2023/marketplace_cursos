      ...
      {courses.length === 0 ? (
        ...
        <div className="flex flex-col gap-3">
          {courses.map(c => {
            ...
            return (
              <div key={c.id} className="flex items-center gap-4 p-4 rounded-2xl border border-border/50 bg-card shadow-sm hover:shadow-md hover:border-brand-green/30 transition-all">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <span className={`text-xs font-semibold px-2.5 py-1 rounded-full border-0 ${st.class}`}>{st.label}</span>
